...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializationView() {
        ...
        sendMessageBtn = (ImageButton) findViewById(R.id.send_btn_id);
    ...
    private void messageSendButton() {
        sendMessageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mMessage = editText.getText().toString().trim();
                ...
                FirebaseDatabase.getInstance()
                        .getReference()
                        .push()
                        .setValue(new ChatMessage(mMessage, FirebaseAuth.getInstance().getCurrentUser().getDisplayName(),true));
    ...
    private void displayChatMessages() {
        ...
        adapter = new FirebaseListAdapter<ChatMessage>(FirebaseDatabase.getInstance().getReference(), ChatMessage.class, R.layout.my_message, this) {
            @Override
